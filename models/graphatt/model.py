"""
Combine Image Relation with Language Relation
"""
...
@Model.register("RelationAttentionQA")
class RelationAttentionQA(Model):
    def __init__(self,
                 vocab: Vocabulary,
        ...
        super(RelationAttentionQA, self).__init__(vocab)
